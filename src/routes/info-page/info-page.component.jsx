...
const InfoPage = () => {
  ...
  if (!planetPic) {
    planetPic = {
      picUrl:
        "https://img.volkskrant.nl/3a26315b5e670c336d1ba3bdf4142d2c2af9eff3/gelukkig-is-alles-op-proxima-centauri-nog-slechter-dan-hier",
    };
  }
  return (
    <>
      <div className="info-container">
        <div className="left-part">
            ...
            <>
              {planetData.mass && (
                <InfoParagraph
                  ...
                  content={`${(planetData.mass * 318).toFixed(
                    2
                  )} Earth's mass.`}
                />
              )}
              ...
              {planetData.radius && (
                <InfoParagraph
                  ...
                  content={`${(planetData.radius * 11).toFixed(
                    2
                  )} Earth's radius.`}
                />
              )}
          ...
          {planetData.name.toLowerCase() === "earth" && (
            <>
              {planetData.mass && (
                <InfoParagraph label={`Population:`} content={`8.1 Billion`} />
              )}
